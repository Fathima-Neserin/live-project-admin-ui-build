...
import { LineChartTwo, PieChartTwo } from "../charts";
  ...
  return (
    <div className="w-full h-1/2  grid place-items-center ">
      <div className="w-[90%] h-full   flex gap-5 ">
        <div className="w-[60%] h-full bg-standard rounded-xl flex flex-col items-center">
        ...
        <div className="w-[37%] h-full bg-standard rounded-xl flex flex-col items-center">
          <div className="w-[90%] h-20  flex items-center justify-between">
            <div>
